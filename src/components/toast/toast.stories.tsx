...
import { AlertProps, AlertSeverity } from '../alert'
...
const alertPropsMap: Record<
  'custom action' | AlertSeverity,
  Partial<Pick<AlertProps, 'action' | 'severity'>>
> = {
  'custom action': { action: <Button variant={'primary'}>Undo</Button> }, // Опционально
  error: { severity: 'error' }, // Только severity
  success: { severity: 'success' }, // Только severity
}
